...
app.get("/api/items", async (req, res) => {
  ...
  let search_param = req.query.q === "" ? undefined : req.query.q;
  console.log("search param", search_param);
  ...
  axios.get(url).then((reponse) => {
    ...
    //console.log("Results:", api_results);
    // console.log("Filters:", api_filters);
    //crear objeto respuesta
    let results = { author: { name: "Lucas", lastname: "Eichhorn" }, categories: [], items: [] };
...
app.get("/api/items/:id", async (req, res) => {
  ...
  console.log(console.log("Item:", api_response.data));
  console.log(console.log("Item:", api_response_description.data));
  //crear objeto respuesta
  let result = { author: { name: "Lucas", lastname: "Eichhorn" }, item: {} };

  //verificamos si obtuve el item de la API
